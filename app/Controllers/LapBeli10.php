        ...
        if (isset($tombolExport)) {
            ...
            if ($typelap == 'REKAP') {
                ...
                foreach ($laporan as $sttb) {
                    $t05 += $sttb['total_invoice'] * $sttb['kursbeli'];
                    ...
                    $spreadsheet->setActiveSheetIndex(0)->setCellValue('G' . $kolom, $sttb['kursbeli']);
                    $spreadsheet->setActiveSheetIndex(0)->setCellValue('H' . $kolom, $sttb['total_invoice']);
                    $spreadsheet->setActiveSheetIndex(0)->setCellValue('I' . $kolom, $sttb['total_invoice'] * $sttb['kursbeli']);
                    $kolom++;
                    $nomor++;
                }
                ...
                foreach ($laporan as $lap) {
                    if ($lap['no_invoice'] != $noinv) {
                        ...
                        $spreadsheet->setActiveSheetIndex(0)->setCellValue('F' . $kolom, $lap['kursbeli']);
                    ...
                    $spreadsheet->setActiveSheetIndex(0)->setCellValue('K' . $kolom, $lap['subtotal'] * $lap['kursbeli']);
                    $noinv = $lap['no_invoice'];
                    $sw = 1;
                    $kolom = $kolom + 1;
                    $nomor++;
