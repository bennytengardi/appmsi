...
use App\Models\ModelLapJual25;
use Config\Services;

use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;

class LapJual25 extends BaseController
{
    function __construct()
    {
        ...
        $this->ModelLapJual25 = new ModelLapJual25();
    }
    ...
    public function index()
    {
        ...
        return view('lapjual25/filter', $data);
    }
    ...
    public function preview()
    {
        ...
        foreach ($trxdbt as $trx1) {
            ...
            $raw2 = [
                ...
                'total_invoice' => $nilai,
                'total_bayar'   => $bayar,
                'kode_divisi'   => $kddivisi
            ];
            $this->ModelLapJual25->insertOutstandingPiutang($raw2);
        }



        $trxcrd = $this->ModelLapJual25->trxCredit($sampai);
        // dd($trxcrd);
        foreach ($trxcrd as $trx2) {
            ...
            $this->ModelLapJual25->updateOutstandingPiutang($raw3);
        }

        $trxrtn = $this->ModelLapJual25->trxRetur($sampai);
        ...
        $laporan = $this->ModelLapJual25->getOutstandingPiutang($kodedivisi);
        ...
        if (isset($tombolCetak)) {
            ...
            return view('lapjual25/tampil', $data);
        }
