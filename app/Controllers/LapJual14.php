...
use App\Models\ModelLapJual14;
use Config\Services;

use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;

class LapJual14 extends BaseController
{
    function __construct()
    {
        ...
        $this->ModelLapJual14 = new ModelLapJual14();
    }
    ...
    public function index()
    {
        ...
        return view('lapjual14/filter', $data);
    }
    ...
    public function preview()
    {
        ...
        $title = "Aging Receivable Detail";
        $this->ModelLapJual14->clearOutstandingPiutang();
        ...
        $trxdbt = $this->ModelLapJual14->trxDebet($sampai, $kodecust);
        foreach ($trxdbt as $trx1) {
            ...
            $this->ModelLapJual14->insertOutstandingPiutang($raw2);
        }



        $trxcrd = $this->ModelLapJual14->trxCredit($sampai, $kodecust);
        foreach ($trxcrd as $trx2) {
            ...
            $this->ModelLapJual14->updateOutstandingPiutang($raw3);
        }

        $trxrtn = $this->ModelLapJual14->trxRetur($sampai, $kodecust);
        ...
        $laporan = $this->ModelLapJual14->getOutstandingPiutang();
        ...
        if (isset($tombolCetak)) {
            ...
            return view('lapjual14/tampil', $data);
        }
