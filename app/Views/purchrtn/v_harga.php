        ...
        <div class="col-md-12">
            <table class="table table-bordered table-sm" width="100%">
                    ...
                    ?>
                        <tr  class="bg-white">
                            ...
                            <td class="p-0 text-center" style="background-color: #e9ecef;vertical-align: middle">
                                <button class="btn btn-xs btn-danger" onclick="hapusitem('<?= $row['id_purchrtn'] ?>' , `<?= $row['nama_barang'] ?>`, '<?= $row['no_retur'] ?>')">DELETE</button>
                                <button class="btn btn-xs btn-success ml-2" onclick="edititem('<?= $row['id_purchrtn'] ?>','<?= $row['no_retur'] ?>',`<?= $row['kode_barang'] ?>`,`<?= $row['nama_barang'] ?>`,'<?= $row['qty'] ?>','<?= $row['kode_satuan'] ?>','<?= $row['harga'] ?>', '<?= $row['subtotal'] ?>')">EDIT</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                ...
                <tr>
                    ...
                    <td class="p-0">
                        <input type="text" id="total_retur" name="total_retur" class="form-control form-control-sm text-right text-bold text-danger" value="<?= number_format($totaldpp * 1.11, 2) ?>" readonly>
                    </td>
                    <td></td>
                </tr>
