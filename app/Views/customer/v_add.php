    ...
    <div class="col-md-8">
        <div class="card card-primary" style="background-image: linear-gradient(#abc4ff, #f5f7fa);">
            ...
            <div class="card-body" style="font-size: 12px;">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form group row mt-1">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="kode_customer" id="kode_customer" class="form-control form-control-sm text-bold text-md text-danger" style="font-size: 12px;height: 28px;" value="<?= $kode_customer ?>" readonly>
                        ...
                        <div class="form group row mt-1">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nama_customer" id="nama_customer" class="form-control form-control-sm" style="font-size: 12px;height: 28px;" onkeyup="this.value = this.value.toUpperCase()" autofocus>
                        ...
                        <div class="form group row mt-1">
                            ...
                            <div class="col-sm-1">
                                <input type="text" name="termin" id="termin" class="form-control form-control-sm  text-right" style="font-size: 12px;height: 28px;">
                            </div>
                ...
                <br>
                <button type="submit" class="btn btn-primary btn-xs tombolSimpanCustomer mt-1">SAVE DATA</button>
...
<script>
    ...
    $('.tombolSimpanCustomer').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('customer/simpandata') ?>",
            data: data,
            dataType: "json",
            processData: false,
            contentType: false,
