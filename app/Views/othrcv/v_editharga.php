    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary" style="height: 40px">
                <h6 class="modal-title mt-n2" id="modalbarangLabel">PENERIMAAN KAS/BANK</h6>                
            ...
            <?= form_open('OthRcv/updateHarga', ['class' => 'formupdateharga']) ?>
            <div class="modal-body" style="background-image: linear-gradient(#abc4ff, #f5f7fa);font-size: 13px;">
                ...
                <div class="form group row mt-2">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="jumlah" id="jumlah" class="form-control form-control-sm text-right autonum2" style="font-size: 13px; height: 26px;"  value="<?= $jumlah ?>" autofocus>
                    </div>
                </div>
