...
<div class="card card-primary" style="background-image: linear-gradient(#abc4ff, #f5f7fa);">
    ...
    <div class="card-body">
        <button type="button" class="btn btn-primary btn-xs tomboltambahbeli mb-2" onclick="window.location='<?= base_url('OthRcv/add') ?>'">
        ...
        <div class="row mt-2 mb-2">
            <div class="col-sm-12">
                <div class="form-inline">
                    <input type="date" name="tglmulai" id="tglmulai" class="form-control form-control-sm date" style="font-size: 12px;height: 28px"  value="<?= session()->get('tglawlothrcv') ?>">
                    <input type="date" name="tglakhir" id="tglakhir" class="form-control form-control-sm date ml-3" style="font-size: 12px;height: 28px" value="<?= session()->get('tglakhothrcv') ?>">
        ...
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-striped table-hover" id="DataOthRcv" width="100%" style="font-size: 12px;">
                <thead class="bg-primary text-center">
                    <tr>
                        <td width="4%">NO</td>
                        <td width="9%">NO VOUCHER</td>
                        <td width="7%">DATE</td>
                        <td width="19%">DEPOSIT TO</td>
...
<script>
    ...
    function listDataOthRcv() {
        var table = $('#DataOthRcv').DataTable({
            "processing": true,
            "serverSide": true,
            "pageLength": 15,
            "order": [],
    ...
    function hapusOthRcv(id_bukti, no_bukti) {
