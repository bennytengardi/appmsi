...
<div class="container">
    <div class="row">
        ...
        <div class="col-5 text-right">
            <?php if (substr($mothrcv['kode_account'], 4) == "1101") { ?>
                <h4>BUKTI PENERIMAAN KAS</h4>
            <?php } else { ?>
                <h4>BUKTI PENERIMAAN BANK</h4>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="row" style="margin-top: -15px;">
        ...
        <div class="col-2">
            <p>: <?= date('d-M-Y', strtotime($mothrcv['tgl_bukti'])) ?></p>
        </div>
    </div>
    <div class="row" style="margin-top: -15px;">
        <div class="col-2">
