...
<div class="card card-primary" style="background-image: linear-gradient(#abc4ff, #f5f7fa);">
    <div class="card-header" style="height: 40px;">
        <h3 class="card-title mt-n1">OTHER DEPOSIT</h3>
    ...
    <div class="card-body" style="font-size: 13px;">
        <div class="row">
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-1">DEPOSIT TO</div>
                    <div class="col-sm-3">
                ...
                <div class="row">
                    <div class="col-sm-1">NO VOUCHER</div>
                    <div class="col-sm-2">
                        ...
                        <input type="hidden" name="no_randomr" id="no_random" value="<?= $no_random ?>">
                ...
                <div class="row">
                    <div class="col-sm-1">NO CHEQUE</div>
                    <div class="col-sm-2">
                ...
                <div class="row">
                    <div class="col-sm-1" id="textkurs"></div>
                    <div class="col-sm-1" id="inputkurs"></div>
                </div>
                <div class="row">
        ...
        <div class="form-group">
            <button class="btn btn-success btn-xs tombolSimpanInv" type="button" id="btnSimpanInv"><i class="fa fa-save"></i>
                SAVE DATA
            </button>
        </div>
    </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(currency, nilai_tukar) {
                    ...
                    if (matauang != 'IDR') {
                       html = '<input type="text" class="form-control form-control-sm text-right" name="kurs" id="kurs" style="font-size: 13px;height: 26px;">';
                       document.getElementById("textkurs").innerHTML = "KURS";
                       $('#inputkurs').html(html);
                       $('#kurs').val(nilaitukar);

                    } else {
                       html = '<input type="hidden" class="form-control form-control-sm text-right" name="kurs" id="kurs" style="font-size: 13px;height: 26px;">';
    ...
    $('.tombolSimpanInv').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('OthRcv/simpandata') ?>",
            data: {
                no_random: norandom,
                no_bukti: nobukti,
                tgl_bukti: tglbukti,
