        ...
        <div class="col-md-4 mt-5">
            <div class="card" style="height: 100%;background-color: lightblue;">
                <div class="card-header bg-primary text-white text-center" style="height: 50px;">
                    <p style="font-size: 16px;">LAPORAN PENJUALAN TAHUNAN</p>
                </div>
                <div class="card-body">
                    <?= form_open('LapJual13/preview') ?>
                    <br>
                    <div class="form group row mt-2">
                        <div class="col-sm-3"></div>
                        <label for="tahun" class="col-sm-3 col-form-label" style="font-weight: normal;">TAHUN </label>
                        <div class="col-sm-3">
