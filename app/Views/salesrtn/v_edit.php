    ...
    <div class="col-md-12">
        <div class="card card-primary" style="background-color: lightskyblue;">
            <div class="card-header" style="height: 50px;">
                ...
                <a href="<?= base_url('SalesRtn/index2/' . $sr['no_retur']) ?>" type="button" class="btn btn-sm mb-2 float-right">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="date" name="tgl_retur" id="tgl_retur" class="form-control form-control-sm" value="<?= $sr['tgl_retur'] ?>">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="keterangan" id="keterangan" class="form-control form-control-sm" value="<?= $sr['keterangan'] ?>" onkeyup="this.value = this.value.toUpperCase()">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $('.tombolSimpanInv').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('SalesRtn/updatedata') ?>",
            data: {
                no_retur: noretur,
                tgl_retur: tglretur,
