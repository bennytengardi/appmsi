...
<div class="card card-primary" style="background-image: linear-gradient(#abc4ff, #f5f7fa);">
    ...
    <div class="card-body">
        <button type="button" class="btn btn-primary btn-xs tomboltambahbeli mb-2" onclick="window.location='<?= base_url('SalesOrd/add') ?>'">
        ...
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-striped table-hover" id="DataSalesOrd" width="100%" style="font-size: 12px;">
                <thead class="bg-primary text-center">
                    <tr>
                        <td width="3%">NO</td>
                        <td width="12%">NO SO</td>
                        <td width="8%">TGL SO</td>
                        <td>CUSTOMER NAME</td>
                        <td width="15%">NO PO</td>
                        <td width="10%">DIVISI</td>
                        <td width="8%">TOTAL SO</td>
...
<script>
    ...
    function listDataSalesOrd() {
        var table = $('#DataSalesOrd').DataTable({
            "processing": true,
            "serverSide": true,
            "pageLength": 16,
            "bDestroy": true,
            "order": [],
            'ajax': {
                "url": "<?= base_url('SalesOrd/listData') ?>",
                "type": "post",
    ...
    function hapusSalesOrd(no_so, nama_customer) {

        Swal.fire({
            html: `Yakin mau menghapus data No SO : <strong> ${no_so}<br>${nama_customer}</strong>`,
