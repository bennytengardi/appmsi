                ...
                <div class="row px-3">
                    <div class="col-sm-7">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm kode_customer " aria-describedby="basic-addon2" name="kode_customer" id="kode_customer" style="font-size: 12px;height:26px;" value="<?= $msalesord['kode_customer'] ?>" onkeyup="this.value = this.value.toUpperCase()">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="nama_pemesan" id="nama_pemesan" class="form-control form-control-sm" style="font-size: 12px;height:26px;" value="<?= $msalesord['nama_pemesan'] ?>">
                            </div>
                        </div>
                        <div class="row mt-n2">
                            <div class="col-md-2 col-form-label">NO HP</div>
                            <div class="col-md-4">
                                <input type="text" name="no_handphone" id="no_handphone" class="form-control form-control-sm" style="font-size: 12px;height:26px;" value="<?= $msalesord['no_handphone'] ?>">
                            </div>
                        </div>
                        <div class="row mt-n2">
                            <div class="col-md-2 col-form-label">NAMA PROYEK</div>
                            <div class="col-md-8">
                                <input type="text" name="nama_proyek" id="nama_proyek" class="form-control form-control-sm" style="font-size: 12px;height:26px;" value="<?= $msalesord['nama_proyek'] ?>">
                            </div>
                        </div>
                        <div class="row mt-n2">
                            ...
                            <div class="col-md-3">
                                <select name="kode_divisi" id="kode_divisi" class="form-control form-control-sm" style="font-size: 12px;height:26px;">
                                    <?php foreach ($divisi as $kat) : ?>
                                        <?php if ($kat['kode_divisi'] == $msalesord['kode_divisi']) : ?>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input type="date" name="tgl_so" id="tgl_so" class="form-control form-control-sm" value="<?= $msalesord['tgl_so'] ?>" style="font-size: 12px;height:26px;" autofocus>
                            </div>
                        </div>                            
                        <div class="row">
                            <div class="col-md-3">NO PO</div>
                            <div class="col-md-5">
                                <input type="text" name="no_po" id="no_po" class="form-control form-control-sm" style="font-size: 12px;height:26px;"  value="<?= $msalesord['no_po'] ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">PEMBAYARAN</div>
                            <div class="col-md-5">
                                <input type="text" name="pembayaran" id="pembayaran" class="form-control form-control-sm" style="font-size: 12px;height:26px;"  value="<?= $msalesord['pembayaran'] ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">TGL KIRIM</div>
                            <div class="col-md-5">
                                <input type="text" name="tgl_kirim" id="tgl_kirim" class="form-control form-control-sm" style="font-size: 12px;height:26px;" value="<?= $msalesord['tgl_kirim'] ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">LOKASI KIRIM</div>
                            <div class="col-md-9">
                                <input type="text" name="lokasi_kirim" id="lokasi_kirim" class="form-control form-control-sm" style="font-size: 12px;height:26px;" value="<?= $msalesord['lokasi_kirim'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control form-control-sm" name="catatan1" id="catatan1" style="font-size: 12px;height:26px;" value="<?= $msalesord['catatan1'] ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-9">
                                <input type="text" class="form-control form-control-sm" name="catatan2" id="catatan2" style="font-size: 12px;height:26px;" value="<?= $msalesord['catatan2'] ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-9">
                                <input type="text" class="form-control form-control-sm" name="catatan3" id="catatan3" style="font-size: 12px;height:26px;" value="<?= $msalesord['catatan3'] ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-9">
                                <input type="text" class="form-control form-control-sm" name="catatan4" id="catatan4" style="font-size: 12px;height:26px;" value="<?= $msalesord['catatan4'] ?>">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('.tombolSimpanInv').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('SalesOrd/updatedata') ?>",
            data: {
                id_so: idso,
                no_so: noso,
                tgl_so: tglso,
            ...
            success: function(response) {
                if (response.error) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            window.location = "<?= base_url('SalesOrd/index2') ?>" + "/" + idso;
                        }
                    });
                }
            },
    ...
    function hitungTotalBelanja() {
        $.ajax({
            url: "<?= site_url('SalesOrd/hitungTotalBelanja2') ?>",
            dataType: "json",
            data: {
                no_so: $('#no_so').val(),
                status: $('#status').val(),
