    ...
    <div class="col-md-12">
        <div class="card card-primary" style="background-color: lightskyblue;">
            <div class="card-header" style="height: 50px;">
                ...
                <a href="<?= base_url('SalesInv/index2/' . $minvoice['id_inv']) ?>" type="button" class="btn btn-sm mb-2 float-right">
                    ...
                    <div class="row p-3">
                        <div class="col-sm-7">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm kode_customer " aria-describedby="basic-addon2" name="kode_customer" id="kode_customer" value="<?= $minvoice['kode_customer'] ?>" onkeyup="this.value = this.value.toUpperCase()" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="hidden" name="status" id="status" class="form-control form-control-sm" value="<?= $minvoice['status'] ?>" readonly>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3">
                                    <select name="kode_divisi" id="kode_divisi" class="form-control form-control-sm">
                                        <?php foreach ($divisi as $kat) : ?>
                                            <?php if ($kat['kode_divisi'] == $minvoice['kode_divisi']) : ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <select name="kodejual" id="kodejual" class="form-control form-control-sm">
                                        <?php if ($minvoice['kodejual'] == 'SALES') : ?>
                                            <option value="SALES" selected>Penjualan</option>
                                            <option value="DP">Uang Muka</option>
                                        <?php else : ?>
                                            <option value="SALES">Penjualan</option>
                                            <option value="DP" selected>Uang Muka</option>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="date" name="tgl_invoice" id="tgl_invoice" class="form-control form-control-sm" value="<?= $minvoice['tgl_invoice'] ?>">
                                    <input type="hidden" name="kode_accjual" id="kode_accjual" value="<?= $minvoice['kode_accjual'] ?>">
                                    <input type="hidden" name="kode_acchpp" id="kode_acchpp" value="<?= $minvoice['kode_acchpp'] ?>">
                                    <input type="hidden" name="kode_accinv" id="kode_accinv" value="<?= $minvoice['kode_accinv'] ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                <input type="text" name="no_suratjln" id="no_suratjln" class="form-control form-control-sm" value="<?= $minvoice['no_suratjln'] ?>" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">PEMBAYARAN</div>
                                <div class="col-md-9">
                                    <input type="text" name="pembayaran" id="pembayaran" class="form-control form-control-sm" value="<?= $minvoice['pembayaran'] ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">DESCRIPTION</div>
                                <div class="col-md-9">
                                    <input type="text" name="keterangan" id="keterangan" class="form-control form-control-sm" value="<?= $minvoice['keterangan'] ?>">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select name="kode_salesman" id="kode_salesman" class="form-control form-control-sm">
                                        ...
                                        <?php if ($sls['kode_salesman'] == $minvoice['kode_salesman']) : ?>
                                            <option value="<?= $sls['kode_salesman'] ?>" selected><?= $sls['nama_salesman'] ?>
                                            </option>
                                        <?php else : ?>
...
<script>
    ...
    $('.tombolSimpanInv').click(function(e) {
        ...
        let kodesalesman = $('#kode_salesman').val();
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('SalesInv/updatedata') ?>",
            data: {
                id_inv: id_inv,
    ...
    function hitungTotalBelanja() {
        ...
        $.ajax({
            url: "<?= site_url('SalesInv/hitungTotalBelanja2') ?>",
            dataType: "json",
            data: {
                no_invoice: $('#no_invoice').val(),
