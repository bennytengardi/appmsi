...
<table class="table" style="font-size: 12px">
    ...
    <td align="right" class="text-bold p-0"><?= number_format($lap['total_dp'], '0', ',', '.') ?></td>
    <td align="right" class="text-bold p-0"><?= number_format($stotinv - $lap['total_dp'], '0', ',', '.') ?></td>
    
    <tr>
        <td colspan="10"></td>
    </tr>
    
    <td colspan="7" class="text-bold p-0">Total Per Divisi</td>
