                ...
                <div class="row" style="font-size: 12px;">
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="no_voucher" id="no_voucher" class="form-control form-control-sm text-bold text-danger" value="<?= $no_voucher ?>"  style="font-size: 12px; height: 26px" readonly>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-1">
                                <input type="date" name="tgl_voucher" id="tgl_voucher" class="form-control form-control-sm"  style="font-size: 12px; height: 26px" value="<?= $tgl_voucher ?>">
                            </div>
                            <!--<div class="col-sm-1 offset-1">-->
                            <!--    <input type="checkbox" id="centang" name="centang" class="centang">-->
                            <!--    <label for="centang">Multi Currency</label>-->
                            <!--</div>                            -->
                        </div>
                    </div>
                ...
                <div class="row mt-3" style="font-size: 12px;">
                    <div class="col-md-1">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-sm  kode_acct" aria-describedby="basic-addon2" name="kode_acct" id="kode_acct" style="font-size: 12px;height: 24px">
                            <div class="input-group-append">
                                <button type="button" class="input-group-text bg-primary tombol-account" id="basic-addon2"  style="font-size: 12px;height: 24px"><i class="fas fa-search" ></i></button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="text-center bg-primary" style="height: 22px;">Account Name</div>
                        <input type="text" class="form-control form-control-sm" name="nama_acct" id="nama_acct" style="font-size: 12px;height: 24px" readonly>
                    </div>
                    <div class="col-md-1">
                        <div class="text-center bg-primary" style="height: 22px;">Debet (IDR)</div>
                        <input type="text" class="form-control form-control-sm text-right autonum2" name="dbt" id="dbt" style="font-size: 12px;height: 24px">
                    </div>
                    <div class="col-md-1">
                        <div class="text-center bg-primary" style="height: 22px;">Credit (IDR)</div>
                        <input type="text" class="form-control form-control-sm text-right autonum2" name="crd" id="crd" style="font-size: 12px;height: 24px">
                    </div>
                    <div class="col-md-1" id="rate1">
                        <div class="text-center bg-primary" style="height: 22px;">Rate</div>
                        <input type="text" class="form-control form-control-sm text-right autonum2" name="rat" id="rat" style="font-size: 12px;height: 24px">
                    </div>
                    <div class="col-md-1" id="pdb">
                        <div class="text-center bg-primary" style="height: 22px;">Prime (Db)</div>
                        <input type="text" class="form-control form-control-sm text-right autonum2" name="prmdb" id="prmdb" style="font-size: 12px;height: 24px" readonly>
                    </div>
                    <div class="col-md-1" id="pcr">
                        <div class="text-center bg-primary" style="height: 22px;">Prime (Cr)</div>
                        <input type="text" class="form-control form-control-sm text-right autonum2" name="prmcr" id="prmcr" style="font-size: 12px;height: 24px" readonly>
                    </div>                    
                    <div class="col-md-2">
                        <div class="text-center bg-primary" style="height: 22px;">Descriptions</div>
                        <input type="text" class="form-control form-control-sm" name="ket" id="ket"  style="font-size: 12px;height: 24px">
                    </div>
                    <div class="col-md-1">
                        <div>&nbsp</div>
...
<script>
        ...
        if (kode_acct.length == 0) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function(kode_account, nama_account,nilai_tukar,currency) {
    ...
    $('.tombolSimpanInv').click(function(e) {
        ...
        if (totaldbt != totalcrd) {
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url('jurnal/simpandata') ?>",
                data: {
