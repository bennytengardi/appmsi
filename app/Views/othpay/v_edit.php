    ...
    <div class="card-body" style="font-size: 13px;">
        <div class="row">
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" name="id_bukti" id="id_bukti" value="<?= $mothpay['id_bukti'] ?>">
                    </div>
                </div>
                <div class="row mt-0">
                    <div class="col-sm-3">DATE</div>
                    <div class="col-sm-4">
                        <input type="date" name="tgl_bukti" id="tgl_bukti" class="form-control form-control-sm " style="font-size: 13px;height: 26px;" value="<?= $mothpay['tgl_bukti'] ?>">
                    </div>
                </div>
                <div class="row mt-0">
                    ...
                    <div class="col-sm-8">
                        <select name="kode_account" id="kode_account" class="form-control form-control-sm" style="font-size: 13px;height: 26px;">
                            <?php foreach ($account as $grp) : ?>
                                <?php if ($grp['kode_account'] == $mothpay['kode_account']) : ?>
                ...
                <div class="row mt-0">
                    <?php if ($mothpay['currency'] != 'IDR') { ?>
                        ...
                        <div class="col-sm-3" id="inputkurs">
                            <input type="text" class="form-control form-control-sm text-right" name="kurs" id="kurs" style="font-size: 13px;height: 26px;" value="<?= $mothpay['nilai_tukar'] ?>" >
                        </div>
                    <?php } else { ?>
                        <div class="col-sm-3" id="textkurs"></div>
                        <div class="col-sm-3" id="inputkurs">
                            <input type="hidden" class="form-control form-control-sm text-right" name="kurs" id="kurs" style="font-size: 13px;height: 26px;" value="<?= $mothpay['nilai_tukar'] ?>" >
                        </div>
                    <?php } ?>
                </div>
            ...
            <div class="col-sm-6 offset-1">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="no_cheque" id="no_cheque" class="form-control form-control-sm" style="font-size: 13px;height: 26px;" value="<?= $mothpay['no_cheque'] ?>" onkeyup="this.value = this.value.toUpperCase()">
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        <select name="kode_divisi" id="kode_divisi" class="form-control form-control-sm" style="font-size: 13px;height: 26px;">
                            <?php foreach ($divisi as $kat) : ?>
                                <?php if ($kat['kode_divisi'] == $mothpay['kode_divisi']) : ?>
                ...
                <div class="row mt-0">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="kepada" id="kepada" class="form-control form-control-sm " style="font-size: 13px;height: 26px;" value="<?= $mothpay['kepada'] ?>" onkeyup="this.value = this.value.toUpperCase()">
                ...
                <div class="row mt-0">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="keterangan" id="keterangan" class="form-control form-control-sm" style="font-size: 13px;height: 26px;" value="<?= $mothpay['keterangan'] ?>">
...
<script>
    ...
    $('.tombolSimpanInv').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('OthPay/updatedata') ?>",
            data: {
                id_bukti: idbukti,
                no_bukti: nobukti,
                tgl_bukti: tglbukti,
