    ...
    <div class="col-md-6">
        <div class="card card-primary" style="background-color: lightblue;">
            <div class="card-header" style="height: 50px;">
                <h3 class="card-title">TAMBAH SALESMAN BARU</h3>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form group row mt-1">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="kode_salesman" id="kode_salesman" style="font-size: 16px; font-weight: bold" class="form-control " value="<?= $kode_salesman ?>" readonly>
                        ...
                        <div class="form group row mt-1">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="nama_salesman" id="nama_salesman" class="form-control " autofocus>
                ...
                <br>
                <button type="submit" class="btn btn-success tombolSimpanSalesman mt-2">SIMPAN DATA</button>
...
<script>
    $('.tombolSimpanSalesman').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('salesman/simpandata') ?>",
            data: data,
            dataType: "json",
            processData: false,
            contentType: false,
            ...
            complete: function() {
                $('.tombolSimpanSalesman').html('SIMPAN DATA');
