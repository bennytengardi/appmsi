        ...
        <div class="card card-primary" style="background-color: #D7ECFF;">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form group row mt-2">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="kode_merk" id="kode_merk" class="form-control form-control-sm border-secondary" onkeyup="this.value = this.value.toUpperCase()" autofocus>
                        ...
                        <div class="form group row mt-4">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="nama_merk" id="nama_merk" class="form-control form-control-sm border-secondary" onkeyup="this.value = this.value.toUpperCase()">
                ...
                <div class="row mt-4 mb-3">
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn-primary btn-sm tombolSimpanMerk">SIMPAN</button>
                    </div>
                </div>
                <?= form_close() ?>
            </div>
            ...
            success: function(response) {
                if (response.error) {
                    ...
                    if (dataError.errorKodeMerk) {
                        ...
                        $('#kode_merk').addClass('is-invalid');
                    } else {
                        $('.errorKodeMerk').fadeOut();
                        $('#kode_merk').removeClass('is-invalid');
                        $('#kode_merk').addClass('is-valid');
                    }
