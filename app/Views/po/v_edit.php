                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm  kode_supplier" aria-describedby="basic-addon2" name="kode_supplier" id="kode_supplier" value="<?= $po['kode_supplier'] ?>">
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" name="id_po" id="id_po" value="<?= $po['id_po'] ?>">                                    
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="date" name="tgl_po" id="tgl_po" class="form-control form-control-sm  " value="<?= $po['tgl_po'] ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">PAYMENT</div>
                                <div class="col-md-5">
                                    <input type="text" name="termin" id="termin" class="form-control form-control-sm" value="<?= $po['termin'] ?>">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="keterangan" id="keterangan" class="form-control form-control-sm" value="<?= $po['keterangan'] ?>">
                                </div>
                            </div>
                        </div>
                    </div>
