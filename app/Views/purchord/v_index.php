...
<div class="card card-primary" style="background-image: linear-gradient(#abc4ff, #f5f7fa);">
    <div class="card-header" style="height: 40px;">
        <h3 class="card-title mt-n1">PURCHASE ORDER</h3>
    ...
    <div class="card-body">
        <button type="button" class="btn btn-primary btn-xs tomboltambahjual mb-2" onclick="window.location='<?= base_url('PurchOrd/add') ?>'">
            <i class="fa fa-plus-circle"></i> Add PO</button>
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-striped table-hover" id="DataPurchOrd" width="100%">
