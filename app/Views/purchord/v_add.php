                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="addkrm1" id="addkrm1" class="form-control form-control-sm" style="font-size: 12px;height: 26px;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="addkrm2" id="addkrm2" class="form-control form-control-sm" style="font-size: 12px;height: 26px;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-9">
                                    <input type="text" name="addkrm3" id="addkrm3" class="form-control form-control-sm" style="font-size: 12px;height: 26px;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">U.P</div>
                                <div class="col-md-5">
                                    <input type="text" name="nama_up" id="nama_up" class="form-control form-control-sm" style="font-size: 12px;height: 26px;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">NO. TELEPON</div>
                                <div class="col-md-5">
                                    <input type="text" name="telepon_up" id="telepon_up" class="form-control form-control-sm" style="font-size: 12px;height: 26px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="no_po" id="no_po" class="form-control form-control-sm text-bold text-danger" style="font-size: 12px;height: 26px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="date" name="tgl_po" id="tgl_po" class="form-control form-control-sm" style="font-size: 12px;height: 26px;" value="<?= $tgl_po ?>" >
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">PAYMENT</div>
                                <div class="col-md-5">
                                    <input type="text" name="termin" id="termin" class="form-control form-control-sm" style="font-size: 12px;height: 26px;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">CURRENCY</div>
                                <div class="col-md-2">
                                    <input type="text" name="currency" id="currency" class="form-control form-control-sm" style="font-size: 12px;height: 26px;" readonly>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="proyek" id="proyek" class="form-control form-control-sm" style="font-size: 12px;height: 26px;">
                                </div>
                            </div>
                            <div class="row">
    ...
    $(document).on('click', '#select', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(kode_supplier, nama_supplier, address1, address2, address3, status, currency, no_hp, personal_kontak) {
