    ...
    <div class="col-sm-8">
        <table class="table">
            <center style="margin-top: 20px;">
                ...
                <p style="margin-top: -8px;">As Of: <?= date('d-M-Y', strtotime($sampai)) ?>
                </p>
            </center>
            <div class="row">
                <div class="col-sm-12">
            ...
            <tbody>
                ...
                foreach ($laporan as $lap) : ?>
                    <?php if ($nmcust != $lap['nama_customer']) : ?>
                        <?php if ($sw == 1) : ?>
                            <tr>
                                <td class="p-0"><?= $kdcust ?></td>
                                <td class="p-0"><?= $nmcust ?></td>
                    ...
                    <?php $nmcust  = $lap['nama_customer']; $kdcust = $lap['kode_customer'];  ?>               
                <?php endforeach; ?>
            </tbody>
            <td class="p-0"><?= $kdcust ?></td>
            <td class="p-0"><?= $nmcust ?></td>
