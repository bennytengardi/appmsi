                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form group row mt-2">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="currency" id="currency" class="form-control form-control-sm border-secondary" value="<?= $currency['currency'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form group row mt-2">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="nama_negara" id="nama_negara" class="form-control form-control-sm border-secondary" value="<?= $currency['nama_negara'] ?>"  onkeyup="this.value = this.value.toUpperCase()">
                            </div>
                        </div>
                        <div class="form group row mt-2">
                            <div class="col-sm-2 col-form-label">Nilai Tukar</div>
                            <div class="col-sm-2">
                                <input type="text" name="nilai_tukar" id="nilai_tukar" class="form-control form-control-sm text-right border-secondary"  value="<?= $currency['nilai_tukar'] ?>">
                            </div>
                        </div>
                        <div class="form group row mt-2">
                            <div class="col-sm-2 col-form-label">Simbol</div>
                            <div class="col-sm-1">
                                <input type="text" name="simbol" id="simbol" class="form-control form-control-sm border-secondary"  value="<?= $currency['simbol'] ?>">
                            </div>
                        </div>
...
<script>
    $('.tombolSimpanCurrency').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('currency/updatedata') ?>",
            data: data,
            dataType: "json",
            processData: false,
            contentType: false,
            ...
            success: function(response) {
                    Swal.fire({
                        ...
                        if (result.value) {
                            window.location = "<?= base_url('currency') ?>";
