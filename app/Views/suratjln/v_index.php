...
<div class="card card-primary" style="background-image: linear-gradient(#abc4ff, #f5f7fa);">
    <div class="card-header" style="height: 40px;">
        <h3 class="card-title mt-n1">DELIVERY ORDER</h3>
    ...
    <div class="card-body">
        ...
        <div class="row mt-2 mb-2">
            <div class="col-sm-12">
                <div class="form-inline">
                    <input type="date" name="tglmulai" id="tglmulai" class="form-control form-control-sm date" style="font-size: 12px;height: 26px;" value="<?= session()->get('tglawlsj') ?>">
                    <input type="date" name="tglakhir" id="tglakhir" class="form-control form-control-sm date ml-3" style="font-size: 12px;height: 26px;" value="<?= session()->get('tglakhsj') ?>">
        ...
        <div class="table-responsive">
            <table class="table table-sm table-striped table-bordered table-hover" id="DataSuratJln" width="100%" style="font-size: 12px;">
...
<script>
    ...
    function hapusSuratJln(no_suratjln, nama_customer) {
        ...
        Swal.fire({
            html: `Yakin mau menghapus data Surat Jalan : <strong> ${no_suratjln}<br>${nama_customer}</strong>`,
